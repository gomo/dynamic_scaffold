...
(function(){
  function createElement(tagName, attributes, style, innerText){
  ...
  window.DynamicScaffold.confirm = function(options){
    ...
    const overlay = createElement('div', {class: 'dynamicScaffold-overlay'})
    const confirm = createElement('div', {class: 'dynamicScaffold-confirm'})
    const inner = createElement('div', {class: 'dynamicScaffold-confirm-inner'})
    overlay.appendChild(confirm)
    confirm.appendChild(inner)
  
    const message = createElement('div', {class: 'dynamicScaffold-confirm-message'}, null, options.message)
    inner.appendChild(message)
    
    const ok = createElement('button', {class: options.ok.class}, {}, options.ok.text)
    const cancel = createElement('button', {class: options.cancel.class}, {}, options.cancel.text)
    const buttons = createElement('div', {class: 'dynamicScaffold-confirm-buttons'})
